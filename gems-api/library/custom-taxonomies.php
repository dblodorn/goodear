...
add_action( 'init', 'capbility_taxonomy', 30 );
  ...
  register_taxonomy( 'capability', array( 'video' ), $args );
}
...
add_action( 'init', 'client_taxonomy', 30 );
  ...
  register_taxonomy( 'client', array( 'video' ), $args );
}
...
add_action( 'init', 'industry_taxonomy', 30 );
  ...
  register_taxonomy( 'industry', array( 'video' ), $args );
}
...
function filter_project_client() {
  tsm_filter_post_type_by_taxonomy('video', 'client');
}

function filter_project_industry() {
  tsm_filter_post_type_by_taxonomy('video', 'industry');
}

function filter_project_capability() {
  tsm_filter_post_type_by_taxonomy('video', 'capability');
}
